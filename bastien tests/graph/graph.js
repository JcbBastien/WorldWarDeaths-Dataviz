...
const response = await fetch("http://localhost:5500/bastien tests/graph/data.json")
...
sortedWW1.forEach((element, i) => {
    ...
    <div class="graphContainer">
      ...
      let WW1MaxDeath = sortedWW1[0].deaths

      // Pourcentage sur 140 car 140 personnes peut être affiché a la fois.
      let currentPercentage = Math.round((element.deaths*140)/WW1MaxDeath)
